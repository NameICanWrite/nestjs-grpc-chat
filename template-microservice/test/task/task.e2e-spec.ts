...
import { TaskStatusReason } from '../../src/template-module/entities/task-status-reason.entity';
import { TaskStatus } from '../../src/template-module/entities/task-status.entity';
import { TaskType } from '../../src/template-module/entities/template-type.entity';
import { TaskWorkType } from '../../src/template-module/entities/task-work-type.entity';
import { Task } from '../../src/template-module/entities/template.entity';
import {
  TaskStatusEnum,
  ...
  TaskWorkTypeEnum,
  TypeEnum,
} from '../../src/template-module/template.enum';
import { TaskModule } from '../../src/template-module/template.module';
import { TASK_SERVICE_NAME, TaskServiceClient } from '../../src/template-module/template.pb';
