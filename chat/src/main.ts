...
import { CHAT_PACKAGE_NAME } from './_proto/chat.pb';
import { COMMON_PACKAGE_NAME } from './_proto/chat.common.pb';
    ...
    AppModule,
    {
      ...
      options: {
        ...
        protoPath: [
          ...
          join(__dirname, '_proto/chat.common.proto'),
          join(__dirname, '_proto/chat.proto'),
        ],
        loader: {
          enums: String,
        },
